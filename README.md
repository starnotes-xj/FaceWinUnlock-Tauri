...
| v0.3.6 | 2026-05-29 | Bug修复 | **Chrome 密码查看器双次人脸识别修复**：DLL 连接后不再自动发送 "run"，统一由输入 Hook 触发，消除第一次失败第二次成功的体验问题<br />**开机面容识别可靠性增强**：BootTrigger 增加 15 秒延迟确保系统服务就绪，新增 LogonTrigger 兜底触发器<br />**无人脸自动重试**：Unlock EXE 在无人脸时内部自动重试最多 3 轮（重新打开摄像头），无需 DLL 重发 "run"
...
本项目涉及修改 Windows 系统内核登录行为。在使用或二次开发时，请务必了