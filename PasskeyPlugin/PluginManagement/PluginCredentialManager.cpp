...
namespace winrt::PasskeyManager::implementation
{
    ...
    HRESULT PluginCredentialManager::DeleteAllPluginCredentials()
    {
        ...
        RETURN_IF_FAILED(WebAuthNPluginAuthenticatorRemoveAllCredentials(facewinunlock_plugin_guid));
    ...
    HRESULT PluginCredentialManager::RefreshAutofillPluginCredentialsList()
    {
        ...
        HRESULT hr = WebAuthNPluginAuthenticatorGetAllCredentials(facewinunlock_plugin_guid, &cCredentialDetails, &ppCredentialDetailsArray);
